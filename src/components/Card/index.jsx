...
const Card = ({item, addToBasket, removeFromBasket, basket}) => {
  ...
  return (
    <div style={{width: "200px" }} className='border rounded p-3 d-flex flex-column 
    align-items-center gap-1'>
        ...
        <div className='d-flex gap-2 mt-4 align-items-center'>
            ...
            onClick={() => removeFromBasket(item.id)} className='btn btn-sm btn-outline-danger'>Azalt</button>
